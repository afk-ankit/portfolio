export const Navbar = () => {
  return (
    <nav className="z-50 bg-white/10 backdrop-blur-lg border-white/20 border h-14 rounded-2xl flex items-center px-4 md:w-fit gap-8 sticky top-8 shadow-lg transition-all duration-300 hover:bg-white/15 hover:border-white/25">
      <a href="#home">
