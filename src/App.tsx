      ...
      <div className="flex justify-between mt-28 gap-8">
        <div className="flex-[0.6] flex flex-col">
          ...
          <p className="text-zinc-400 mt-8">
            Meet Ankit Sharma, freelance web developer, and entrepreneur known
            ...
            Samtal.io, white-labeled Social Media to help businesses connect
          ...
          <button className="py-2 px-6 bg-accent w-fit rounded-md cursor-pointer mt-8">
            Let's connect
          </button>
        </div>
